...
/**
 * readSDKPath retrieves the path to the PlaydateSDK folder. The SDK folder can
 ...
 */
export async function readSDKPath(): Promise<string> {
...
async function readSDKPathConfig(): Promise<string | undefined> {
