...
## [1.19.1] - 2025-04-06 (Pre-release)

### Added

- Playdate Simulator task `argv` option can send additional args to the Playdate game

### Fixed

- Document `incrementBuildNumber`, `libPath` and `argv` options in fixtures
